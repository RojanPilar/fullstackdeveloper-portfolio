      ...
      <div class="row g-4 g-lg-5 align-items-center">
        ...
        <div class="col-lg-6">
          ...
          <div class="premium-card p-4">
            ...
            <a href="mailto:rojan@example.com" class="btn-blue w-100 text-center text-white fw-bold">Email me ↗</a>
          </div>
        </div>
          ...
          <div class="premium-card p-4 p-md-5">
            <div class="row align-items-center">
              <div class="col-lg-5 text-center text-lg-start mb-4 mb-lg-0">
                ...
                <a href="#landing" class="btn-blue rounded-pill px-4 text-white">Resume ↗</a>
              </div>
              <div class="col-lg-7">
                <div class="row g-2">
                  <div class="col-6 col-sm-3 col-lg-6" v-for="social in ['GitLab', 'GitHub', 'Facebook', 'LinkedIn']" :key="social">
                    <a href="#" class="btn-blue w-100 text-center p-2 rounded text-white text-nowrap">{{ social }} ↗</a>
                  </div>
                </div>
              </div>
            </div>
